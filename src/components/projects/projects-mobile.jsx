    ...
    <section className="block lg:hidden z-0 min-h-screen scroll-section-outer overflow-hidden bg-[#0d1117] px-4 py-8">
      ...
      {projects.map((project, index) => (
        ...
        >
          ...
          <div className="text-center text-white font-nunito_sans mb-4">
            <h3 className="text-xl font-extrabold text-[#edede5]">
              {project.title}
            </h3>
            <p className="text-sm font-semibold text-[#edede5]">
              {project.description}
            </p>
